...
#define UsartRs485Config()    Usart1Config()
#define UsartRs485Send(X)    Usart1Send(X)
#define UsartRs485ReadBuffer(X,Y)    Usart1ReadBuffer(X,Y)
#define UsartRs485HaveData()    Usart1HaveData()
#define UsartRs485HaveDataReset()    Usart1HaveDataReset()
#define UsartRs485Shutdown()    Usart1Shutdown()
